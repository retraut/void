/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 76513408f4746b10cb0a8f674fc5b5d0)
// Runtime types generated with workerd@1.20260625.1 2026-06-24 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	...
	void_cell: DurableObjectNamespace<import("./src/index").VoidCell>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VoidCell";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_WEBHOOK_SECRET" | "VOID_BEARER_TOKEN" | "AGENT_SHARED_SECRET">> {}
}
